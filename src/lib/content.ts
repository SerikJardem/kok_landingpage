...
export const model = {
  lead: "Как это работает в Көк: Вы открываете точку продажи, а готовит франчайзер.",
...
export const territories = {
  stamp: "ГОРОДА",
  title: "Свободные города",
  deck: "Города, где ещё можно открыть точку. Midi в стрит-ритейле. Express на фудкорте. Статус — живая таблица.",
